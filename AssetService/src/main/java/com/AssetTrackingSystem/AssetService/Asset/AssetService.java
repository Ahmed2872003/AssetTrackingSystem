...
import com.AssetTrackingSystem.AssetService.Exceptions.ConflictException;
...
public class AssetService {
    ...
    public Asset updateAssetById(Long id, Asset newAssetData) {
        ...
        if(assetRecord.isPresent()){
            ...
            if(Objects.equals(newAssetData.getStatus(), Asset.Status.UNDER_MAINTAINANCE.toString()) && Objects.equals(originalAsset.getStatus(), Asset.Status.ASSIGNED.toString()))
                throw new ConflictException("Asset is assigned to staff");
